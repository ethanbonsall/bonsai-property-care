  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center mx-[2%] mt-[4%] lg:mt-0 2xl:gap-y-8">
        ...
        >
          At Bonsai Property Care, our professional power washing services
          restore the clean, fresh look of your home and outdoor spaces. From
          driveways and patios to siding, decks, and walkways, we remove dirt,
          mold, and grime to keep your property looking its best year-round.
        </p>
        <div
        ...
        >
          <li>Restore Curb Appeal</li>
          <li>Protect Surfaces</li>
