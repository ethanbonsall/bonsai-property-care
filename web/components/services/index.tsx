        ...
        <div className="flex flex-col justify-normal xl:justify-evenly gap-y-[1%] lg:gap-y-0 lg:flex-row ">
          {[
            ...
            <Link
              key={service.href}
              href={service.href}
              className="transition-all duration-300 hover:scale-105 w-[200px] md:w-[500px] lg:w-[400px] xl:w-[500px] 2xl:w-[700px] lg:mx-[5dvw] my-[2dvh] xl:my-[1dvh] hover:shadow-[0_0_30px_rgba(255,255,255,0.8)] rounded-[35px] bg-accent"
            >
