...
import Caleb from "@/public/assets/driveway-sealing-1.jpg";
import Work from "@/public/assets/driveway-sealing-2.jpg";
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center justify-center w-full lg:w-2/5 py-[4%] gap-x-4 2xl:gap-x-16">
        <img
          src={Caleb.src}
          alt="Driveway sealing in progress"
      ...
      <p
          className={`font-bold text-6xl xl:text-[80px] 2xl:text-[120px] transition-all duration-700 ease-out md:text-nowrap ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          } `}
        >
          Driveway Sealing
        ...
        >
          Our driveway sealing services protect and preserve your asphalt,
          extending its life while giving it a sleek, polished look. We seal
          cracks, prevent water damage, and shield your driveway from weather,
          oil, and daily wear so your property maintains its curb appeal.
        </p>
        <div
        ...
        >
          <li>Protect Against Cracks</li>
          <li>Weather & Water Resistance</li>
